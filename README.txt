...
a persistence unit "eva62GuachunPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Guachun/pom.xml":
...
artifact ("eva62Guachun.war") is already built. You can build
